...
{
    public static void AddStorageServiceOpenTelemetry(this IServiceCollection services, ILoggingBuilder loggingBuilder, IConfiguration configuration)
    {
        ...
        services.AddOpenTelemetry()
            .ConfigureResource(builder => builder.AddService("storage-service"))
            .WithMetrics(builder =>
            {
                builder
    ...
    public static void UseStorageServiceOpenTelemetry(this WebApplication app)
    {
